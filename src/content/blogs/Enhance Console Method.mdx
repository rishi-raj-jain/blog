...
import img3 from '@/assets/images/000003.png';
import img4 from '@/assets/images/000004.png';
import img5 from '@/assets/images/000005.png';
import img6 from '@/assets/images/000006.png';
import img7 from '@/assets/images/000007.png';
import img8 from '@/assets/images/000008.png';
import img9 from '@/assets/images/000009.png';
import img10 from '@/assets/images/000010.png';
import img11 from '@/assets/images/000011.png';
import img12 from '@/assets/images/000012.png';
...
<Image src={img4} alt='babel parse' />

transform 阶段是对 AST 的处理，对 AST 遍历的过程中遇到不同的节点会调用相应的 visitor 函数，visitor 函数里可以对节点进行增删改，返回新的 AST。这样遍历完 AST 之后就完成了对代码的修改。

<Image src={img5} alt='babel transform' />

generate 阶段将 AST 打印成目标代码字符串，并且会生成 sourcemap。不同的 AST 对应的不同结构的字符串。比如 `IfStatement` 节点可以生成 `if(){}` 格式的代码。

## babel 的 AST

JS parser 的 AST 大多遵循了 [estree](https://github.com/estree/estree) 标准。常见的 AST 节点有：

- <u>Literal 字面量节点</u>。

  <Image src={img6} alt='Literal' />

- <u>Identifier 标识符</u>，变量名、属性名、参数名等各种声明和引用的名字。

  <Image src={img7} alt='Identifier' />

- <u>Statement 语句</u>（可独立执行的单元）。

  <Image src={img8} alt='Statement' />

- <u>Declaration 声明变量</u>。

  <Image src={img9} alt='Declaration' />

- <u>Expression 表达式</u>，执行完以后有返回值。

  <Image src={img10} alt='Expression' />
...
<Image src={img11} alt='Visit' />

path 是遍历过程中的路径，会保留上下文信息，有很多属性和方法，比如:

<Image src={img12} alt='Path' />
...
[Github demo](https://github.com/CaptainOfPhB/enhance-console-method)
